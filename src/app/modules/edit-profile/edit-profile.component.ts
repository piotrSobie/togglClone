...
export class EditProfileComponent implements OnInit {
  ...
  private user: UserProfileInterface = { _id: "", email: "", location: "", password: ""};
  private error = '';
  private operation;
  ...
  userLocations = [
    ...
    { value: 'KP', name: 'Korea, Democratic Peoples Republic of' },
    { value: 'KR', name: 'Korea, Republic of' },
    { value: 'KW', name: 'Kuwait' },
    { value: 'KG', name: 'Kyrgyzstan' },
    { value: 'LA', name: 'Lao Peoples Democratic Republic' },
